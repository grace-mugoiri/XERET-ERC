...
contract('Xeret', function(accounts) {
    ...
    it('Initializes the first contract with the correct values', function() {
        return XeretToken.deployed().then(function(instance) {
            ...
            assert.equal(name, 'Xeret Token', 'has the correct name');
            return tokenInstance.symbol();
        }).then(function(symbol) {
            assert.equal(symbol, 'XRT', 'has the correct symbol');
            return tokenInstance.standard();
        }).then(function(standard) {
            assert.equal(standard, 'XERET Token v1.0', 'has the correct standard');
        });
    });
    ...
    it('allocates the inital supply upon deployment', function() {
        return XeretToken.deployed().then(function(instance) {
            ...
            assert.equal(totalSupply.toNumber(), 1000000, 'sets the total supple to 1,000,000');
    ...
    it('transfers token ownership', function() {
        return XeretToken.deployed().then(function(instance) {
            ...
            return tokenInstance.transer.call(accounts[1], 250000, {from: accounts[0] })
            ...
            assert.equal(receipt.logs[0]._value, 250000, 'logs the transfer amount');
    ...
    it('approves token delegated transfer', function() {
        return XeretToken.deployed().then(function(instance) {
            tokenInstance = instance;
    ...
    it('handles delegated tokens transfer', function() {
        return XeretToken.deployed().then(function(instance) {
            tokenInstance = instance;
